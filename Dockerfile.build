...
FROM alpine:3.23.2@sha256:865b95f46d98cf867a156fe4a135ad3fe50d2056aa3f25ed31662dff6da4eb62 AS setcapper
ARG TARGETOS
ARG TARGETARCH
...
FROM alpine:3.23.2@sha256:865b95f46d98cf867a156fe4a135ad3fe50d2056aa3f25ed31662dff6da4eb62 AS release
ARG TARGETOS
ARG TARGETARCH
ARG HOST_DIST=$TARGETOS-$TARGETARCH
...
ADD --chown=sm:sm --chmod=0500 https://github.com/grafana/xk6-sm/releases/download/v0.6.15/sm-k6-${TARGETOS}-${TARGETARCH} /usr/local/bin/sm-k6
...
FROM ghcr.io/grafana/chromium-swiftshader-alpine:143.0.7499.169-r0-3.23.2@sha256:4c106aa1f33ab84e9707470f2142413660fce33e4fad39d3d58d44c73a1b5509 AS with-browser
