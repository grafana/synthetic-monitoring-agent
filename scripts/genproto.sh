...
PB_ROOT="$(GO111MODULE=on go list -f '{{.Dir}}' ./internal/pkg/pb)"
PB_IMPORT_PATH="$(GO111MODULE=on go list -f '{{.ImportPath}}' ./internal/pkg/pb)"
PB_PATH="${PB_ROOT}:${PB_ROOT}/prompb"
PROMPB_IMPORT_PATH="${PB_IMPORT_PATH}/prompb"
LOGPROTO_IMPORT_PATH="${PB_IMPORT_PATH}/logproto"
...
DIRS="internal/pkg/pb/logproto internal/pkg/pb/prompb internal/pkg/pb/worldping"
