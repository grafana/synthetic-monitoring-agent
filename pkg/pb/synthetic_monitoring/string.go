// Code generated by "enumer -type=CheckType,CheckClass -trimprefix=CheckType,CheckClass -transform=snake -output string.go"; DO NOT EDIT.
...
const _CheckTypeName = "dnshttppingtcptraceroutek6multi_http"

var _CheckTypeIndex = [...]uint8{0, 3, 7, 11, 14, 24, 26, 36}

const _CheckTypeLowerName = "dnshttppingtcptraceroutek6multi_http"
...
var _CheckTypeNameToValueMap = map[string]CheckType{
	...
	_CheckTypeName[26:36]:      CheckTypeMultiHttp,
	_CheckTypeLowerName[26:36]: CheckTypeMultiHttp,
}
