...
const (
	...
	CheckClass_BROWSER  CheckClass = 2
)
...
type ProbeInfo struct {
	...
	SupportsProtocolSecrets bool   `protobuf:"varint,4,opt,name=supportsProtocolSecrets,proto3" json:"supportsProtocolSecrets"`
}
...
type Probe_Capabilities struct {
	...
	DisableBrowserChecks     bool `protobuf:"varint,2,opt,name=disableBrowserChecks,proto3" json:"disableBrowserChecks"`
	EnableProtocolSecrets    bool `protobuf:"varint,3,opt,name=enableProtocolSecrets,proto3" json:"enableProtocolSecrets"`
	EnableLLMEvaluatorChecks bool `protobuf:"varint,4,opt,name=enableLLMEvaluatorChecks,proto3" json:"enableLLMEvaluatorChecks"`
}
...
type TenantLimits struct {
	...
	MaxBrowserChecks  int64 `protobuf:"varint,5,opt,name=maxBrowserChecks,proto3" json:"maxBrowserChecks"`
}
...
type SecretStore struct {
	...
	Expiry float64 `protobuf:"fixed64,3,opt,name=expiry,proto3" json:"expiry"`
}
...
type Tenant struct {
	...
	CostAttributionLabels []string      `protobuf:"bytes,9,rep,name=costAttributionLabels,proto3" json:"costAttributionLabels"`
	Created               float64       `protobuf:"fixed64,100,opt,name=created,proto3" json:"created"`
	Modified              float64       `protobuf:"fixed64,101,opt,name=modified,proto3" json:"modified"`
	SecretStore           *SecretStore  `protobuf:"bytes,102,opt,name=secretStore,proto3" json:"secretStore"`
}
...
// CostAttributionLabel is similar to a label, but specifically for transmitting costAttributionLabels.
// The initial use case for CAL's is such that they are effectively the same as labels.
// Over time that will change, so we should treat them as separate messages to ensure they do not become tightly coupled.
type CostAttributionLabel struct {
	Name  string `protobuf:"bytes,1,opt,name=name,proto3" json:"name"`
	Value string `protobuf:"bytes,2,opt,name=value,proto3" json:"value"`
}

func (m *CostAttributionLabel) Reset()         { *m = CostAttributionLabel{} }
func (m *CostAttributionLabel) String() string { return proto.CompactTextString(m) }
func (*CostAttributionLabel) ProtoMessage()    {}
func (*CostAttributionLabel) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{18}
}
func (m *CostAttributionLabel) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CostAttributionLabel) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CostAttributionLabel.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CostAttributionLabel) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CostAttributionLabel.Merge(m, src)
}
func (m *CostAttributionLabel) XXX_Size() int {
	return m.Size()
}
func (m *CostAttributionLabel) XXX_DiscardUnknown() {
	xxx_messageInfo_CostAttributionLabel.DiscardUnknown(m)
}

var xxx_messageInfo_CostAttributionLabel proto.InternalMessageInfo
...
type Check struct {
	...
	Channels         *Channels     `protobuf:"bytes,14,opt,name=channels,proto3" json:"channels"`
	Created          float64       `protobuf:"fixed64,100,opt,name=created,proto3" json:"created"`
	Modified         float64       `protobuf:"fixed64,101,opt,name=modified,proto3" json:"modified"`
}
...
type AdHocCheck struct {
	...
	Channels *Channels     `protobuf:"bytes,7,opt,name=channels,proto3" json:"channels"`
}
...
type CheckSettings struct {
	...
	LlmEvaluator *LLMEvaluatorSettings `protobuf:"bytes,10,opt,name=llmEvaluator,proto3" json:"llmEvaluator,omitempty"`
}
...
type HttpSettings struct {
	...
	SecretManagerEnabled         bool                 `protobuf:"varint,901,opt,name=secretManagerEnabled,proto3" json:"secretManagerEnabled,omitempty"`
}
...
// LLMEvaluatorSettings provides the settings for an LLM Evaluator check.
// An LLM Evaluator check sends a prompt to any OpenAI-compatible LLM endpoint
// on a schedule, evaluates the response against a list of natural-language
// criteria using a PoP-local judge proxy (sm-judge-proxy), and emits
// per-criterion pass/fail metrics.
//
// The target LLM's API key is stored as an SM Secret referenced by apiKeyRef,
// fetched at execution time via SecretProvider.GetSecretValue. The probe must
// have both enableLLMEvaluatorChecks and enableProtocolSecrets set to true.
type LLMEvaluatorSettings struct {
	...
	ApiKeyRef    string   `protobuf:"bytes,3,opt,name=apiKeyRef,proto3" json:"apiKeyRef"`
	SystemPrompt string   `protobuf:"bytes,4,opt,name=systemPrompt,proto3" json:"systemPrompt,omitempty"`
	Prompt       string   `protobuf:"bytes,5,opt,name=prompt,proto3" json:"prompt"`
	Criteria     []string `protobuf:"bytes,6,rep,name=criteria,proto3" json:"criteria"`
}

func (m *LLMEvaluatorSettings) Reset()         { *m = LLMEvaluatorSettings{} }
func (m *LLMEvaluatorSettings) String() string { return proto.CompactTextString(m) }
func (*LLMEvaluatorSettings) ProtoMessage()    {}
func (*LLMEvaluatorSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{44}
}
func (m *LLMEvaluatorSettings) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LLMEvaluatorSettings) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LLMEvaluatorSettings.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LLMEvaluatorSettings) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LLMEvaluatorSettings.Merge(m, src)
}
func (m *LLMEvaluatorSettings) XXX_Size() int {
	return m.Size()
}
func (m *LLMEvaluatorSettings) XXX_DiscardUnknown() {
	xxx_messageInfo_LLMEvaluatorSettings.DiscardUnknown(m)
}

var xxx_messageInfo_LLMEvaluatorSettings proto.InternalMessageInfo

// Channels represents the channels a check is assigned to.
type Channels struct {
	K6 *K6Channel `protobuf:"bytes,1,opt,name=k6,proto3" json:"k6"`
}
...
// K6Channel represents the k6 channel a check is assigned to.
type K6Channel struct {
	Id       string `protobuf:"bytes,1,opt,name=id,proto3" json:"id"`
	Manifest string `protobuf:"bytes,2,opt,name=manifest,proto3" json:"manifest"`
}

func (m *K6Channel) Reset()         { *m = K6Channel{} }
func (m *K6Channel) String() string { return proto.CompactTextString(m) }
func (*K6Channel) ProtoMessage()    {}
func (*K6Channel) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{46}
}
func (m *K6Channel) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *K6Channel) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_K6Channel.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *K6Channel) XXX_Merge(src proto.Message) {
	xxx_messageInfo_K6Channel.Merge(m, src)
}
func (m *K6Channel) XXX_Size() int {
	return m.Size()
}
func (m *K6Channel) XXX_DiscardUnknown() {
	xxx_messageInfo_K6Channel.DiscardUnknown(m)
}

var xxx_messageInfo_K6Channel proto.InternalMessageInfo
...
func (*RegionTelemetry) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{47}
}
...
func (*TenantTelemetry) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{48}
}
...
type CheckClassTelemetry struct {
	...
	CostAttributionLabels []CostAttributionLabel `protobuf:"bytes,5,rep,name=costAttributionLabels,proto3" json:"costAttributionLabels"`
}
...
func (*CheckClassTelemetry) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{49}
}
...
func (*PushTelemetryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{50}
}
...
// K6Version represents a specific k6 version supported by a probe.
type K6Version struct {
	Version string `protobuf:"bytes,1,opt,name=version,proto3" json:"version"`
}

func (m *K6Version) Reset()         { *m = K6Version{} }
func (m *K6Version) String() string { return proto.CompactTextString(m) }
func (*K6Version) ProtoMessage()    {}
func (*K6Version) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{51}
}
func (m *K6Version) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *K6Version) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_K6Version.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *K6Version) XXX_Merge(src proto.Message) {
	xxx_messageInfo_K6Version.Merge(m, src)
}
func (m *K6Version) XXX_Size() int {
	return m.Size()
}
func (m *K6Version) XXX_DiscardUnknown() {
	xxx_messageInfo_K6Version.DiscardUnknown(m)
}

var xxx_messageInfo_K6Version proto.InternalMessageInfo

type RegisterK6VersionRequest struct {
	Versions []K6Version `protobuf:"bytes,1,rep,name=versions,proto3" json:"versions"`
}

func (m *RegisterK6VersionRequest) Reset()         { *m = RegisterK6VersionRequest{} }
func (m *RegisterK6VersionRequest) String() string { return proto.CompactTextString(m) }
func (*RegisterK6VersionRequest) ProtoMessage()    {}
func (*RegisterK6VersionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{52}
}
func (m *RegisterK6VersionRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RegisterK6VersionRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RegisterK6VersionRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RegisterK6VersionRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RegisterK6VersionRequest.Merge(m, src)
}
func (m *RegisterK6VersionRequest) XXX_Size() int {
	return m.Size()
}
func (m *RegisterK6VersionRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_RegisterK6VersionRequest.DiscardUnknown(m)
}

var xxx_messageInfo_RegisterK6VersionRequest proto.InternalMessageInfo

type RegisterK6VersionResponse struct {
	Status Status `protobuf:"bytes,1,opt,name=status,proto3" json:"status"`
}

func (m *RegisterK6VersionResponse) Reset()         { *m = RegisterK6VersionResponse{} }
func (m *RegisterK6VersionResponse) String() string { return proto.CompactTextString(m) }
func (*RegisterK6VersionResponse) ProtoMessage()    {}
func (*RegisterK6VersionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{53}
}
func (m *RegisterK6VersionResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RegisterK6VersionResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RegisterK6VersionResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RegisterK6VersionResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RegisterK6VersionResponse.Merge(m, src)
}
func (m *RegisterK6VersionResponse) XXX_Size() int {
	return m.Size()
}
func (m *RegisterK6VersionResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_RegisterK6VersionResponse.DiscardUnknown(m)
}

var xxx_messageInfo_RegisterK6VersionResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*SecretStore)(nil), "synthetic_monitoring.SecretStore")
	...
	proto.RegisterType((*CostAttributionLabel)(nil), "synthetic_monitoring.CostAttributionLabel")
	...
	proto.RegisterType((*LLMEvaluatorSettings)(nil), "synthetic_monitoring.LLMEvaluatorSettings")
	proto.RegisterType((*Channels)(nil), "synthetic_monitoring.Channels")
	proto.RegisterType((*K6Channel)(nil), "synthetic_monitoring.K6Channel")
	...
	proto.RegisterType((*K6Version)(nil), "synthetic_monitoring.K6Version")
	proto.RegisterType((*RegisterK6VersionRequest)(nil), "synthetic_monitoring.RegisterK6VersionRequest")
	proto.RegisterType((*RegisterK6VersionResponse)(nil), "synthetic_monitoring.RegisterK6VersionResponse")
}
...
var fileDescriptor_a921b63774164c1f = []byte{
	...
	,
}
...
// K6Client is the client API for K6 service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type K6Client interface {
	// RegisterK6Version registers the k6 versions supported by the probe.
	RegisterK6Version(ctx context.Context, in *RegisterK6VersionRequest, opts ...grpc.CallOption) (*RegisterK6VersionResponse, error)
}
...
func NewK6Client(cc *grpc.ClientConn) K6Client {
	return &k6Client{cc}
}

func (c *k6Client) RegisterK6Version(ctx context.Context, in *RegisterK6VersionRequest, opts ...grpc.CallOption) (*RegisterK6VersionResponse, error) {
	out := new(RegisterK6VersionResponse)
	err := c.cc.Invoke(ctx, "/synthetic_monitoring.K6/RegisterK6Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// K6Server is the server API for K6 service.
type K6Server interface {
	// RegisterK6Version registers the k6 versions supported by the probe.
	RegisterK6Version(context.Context, *RegisterK6VersionRequest) (*RegisterK6VersionResponse, error)
}

// UnimplementedK6Server can be embedded to have forward compatible implementations.
type UnimplementedK6Server struct {
}

func (*UnimplementedK6Server) RegisterK6Version(ctx context.Context, req *RegisterK6VersionRequest) (*RegisterK6VersionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterK6Version not implemented")
}

func RegisterK6Server(s *grpc.Server, srv K6Server) {
	s.RegisterService(&_K6_serviceDesc, srv)
}

func _K6_RegisterK6Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterK6VersionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(K6Server).RegisterK6Version(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/synthetic_monitoring.K6/RegisterK6Version",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(K6Server).RegisterK6Version(ctx, req.(*RegisterK6VersionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _K6_serviceDesc = grpc.ServiceDesc{
	ServiceName: "synthetic_monitoring.K6",
	HandlerType: (*K6Server)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RegisterK6Version",
			Handler:    _K6_RegisterK6Version_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "checks.proto",
...
func (m *TenantLimits) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MaxBrowserChecks != 0 {
		i = encodeVarintChecks(dAtA, i, uint64(m.MaxBrowserChecks))
		i--
		dAtA[i] = 0x28
	}
	if m.MaxLogLabels != 0 {
...
func (m *Tenant) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CostAttributionLabels) > 0 {
		for iNdEx := len(m.CostAttributionLabels) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.CostAttributionLabels[iNdEx])
			copy(dAtA[i:], m.CostAttributionLabels[iNdEx])
			i = encodeVarintChecks(dAtA, i, uint64(len(m.CostAttributionLabels[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
...
func (m *CostAttributionLabel) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CostAttributionLabel) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CostAttributionLabel) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AdHocCheck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Probes) > 0 {
		dAtA17 := make([]byte, len(m.Probes)*10)
		var j16 int
		for _, num1 := range m.Probes {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(j16))
		i--
		dAtA[i] = 0x2a
	}
	{
...
func (m *CheckSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LlmEvaluator != nil {
		{
			size, err := m.LlmEvaluator.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HttpSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ValidStatusCodes) > 0 {
		dAtA30 := make([]byte, len(m.ValidStatusCodes)*10)
		var j29 int
		...
		i = encodeVarintChecks(dAtA, i, uint64(j29))
		i--
		dAtA[i] = 0xc
		i--
		dAtA[i] = 0xd2
...
func (m *LLMEvaluatorSettings) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LLMEvaluatorSettings) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LLMEvaluatorSettings) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Criteria) > 0 {
		for iNdEx := len(m.Criteria) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Criteria[iNdEx])
			copy(dAtA[i:], m.Criteria[iNdEx])
			i = encodeVarintChecks(dAtA, i, uint64(len(m.Criteria[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
	if len(m.Prompt) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.Prompt)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.SystemPrompt) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.SystemPrompt)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.ApiKeyRef) > 0 {
		i -= len(m.ApiKeyRef)
		copy(dAtA[i:], m.ApiKeyRef)
		i = encodeVarintChecks(dAtA, i, uint64(len(m.ApiKeyRef)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Model) > 0 {
		i -= len(m.Model)
		copy(dAtA[i:], m.Model)
		i = encodeVarintChecks(dAtA, i, uint64(len(m.Model)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Endpoint) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.Endpoint)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *K6Channel) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *K6Channel) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *K6Channel) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Manifest) > 0 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(len(m.Manifest)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Id) > 0 {
...
func (m *CheckClassTelemetry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CostAttributionLabels) > 0 {
		for iNdEx := len(m.CostAttributionLabels) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CostAttributionLabels[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *K6Version) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *K6Version) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *K6Version) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RegisterK6VersionRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RegisterK6VersionRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RegisterK6VersionRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RegisterK6VersionResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RegisterK6VersionResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RegisterK6VersionResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TenantLimits) Size() (n int) {
	...
	if m.MaxBrowserChecks != 0 {
		n += 1 + sovChecks(uint64(m.MaxBrowserChecks))
	}
	return n
}
...
func (m *Tenant) Size() (n int) {
	...
	if len(m.CostAttributionLabels) > 0 {
		for _, s := range m.CostAttributionLabels {
			l = len(s)
			n += 1 + l + sovChecks(uint64(l))
		}
	}
...
func (m *CostAttributionLabel) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LLMEvaluatorSettings) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CheckClassTelemetry) Size() (n int) {
	...
	if len(m.CostAttributionLabels) > 0 {
		for _, e := range m.CostAttributionLabels {
			l = e.Size()
			n += 1 + l + sovChecks(uint64(l))
		}
	}
...
func (m *RegisterK6VersionRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RegisterK6VersionResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *CheckSettings) GetValue() interface{} {
	...
	if this.LlmEvaluator != nil {
		return this.LlmEvaluator
	}
	return nil
}
...
func (this *CheckSettings) SetValue(value interface{}) bool {
	...
	case *BrowserSettings:
		this.Browser = vt
	case *LLMEvaluatorSettings:
		this.LlmEvaluator = vt
	default:
		return false
	}
	return true
...
func (m *ProbeInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SupportsProtocolSecrets", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SupportsProtocolSecrets = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipChecks(dAtA[iNdEx:])
			if err != nil {
...
func (m *Probe_Capabilities) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisableBrowserChecks", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DisableBrowserChecks = bool(v != 0)
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableProtocolSecrets", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableProtocolSecrets = bool(v != 0)
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableLLMEvaluatorChecks", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableLLMEvaluatorChecks = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipChecks(dAtA[iNdEx:])
			if err != nil {
...
func (m *TenantLimits) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxBrowserChecks", wireType)
			}
			m.MaxBrowserChecks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowChecks
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxBrowserChecks |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Tenant) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CostAttributionLabels", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CostAttributionLabels = append(m.CostAttributionLabels, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 100:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field Created", wireType)
...
func (m *CostAttributionLabel) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CostAttributionLabel: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CostAttributionLabel: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CheckSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LlmEvaluator", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LlmEvaluator == nil {
				m.LlmEvaluator = &LLMEvaluatorSettings{}
			}
			if err := m.LlmEvaluator.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *HttpSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 901:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecretManagerEnabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SecretManagerEnabled = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipChecks(dAtA[iNdEx:])
			if err != nil {
...
func (m *LLMEvaluatorSettings) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LLMEvaluatorSettings: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LLMEvaluatorSettings: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ApiKeyRef", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ApiKeyRef = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
		...
		case 6:
			...
			m.Criteria = append(m.Criteria, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipChecks(dAtA[iNdEx:])
...
func (m *K6Channel) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: K6Channel: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: K6Channel: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CheckClassTelemetry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.CostAttributionLabels = append(m.CostAttributionLabels, CostAttributionLabel{})
			if err := m.CostAttributionLabels[len(m.CostAttributionLabels)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *K6Version) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: K6Version: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: K6Version: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RegisterK6VersionRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RegisterK6VersionRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RegisterK6VersionRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Versions = append(m.Versions, K6Version{})
...
func (m *RegisterK6VersionResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RegisterK6VersionResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RegisterK6VersionResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
