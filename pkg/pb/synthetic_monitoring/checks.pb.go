...
type Check struct {
	...
	Alerts           CheckAlerts   `protobuf:"bytes,14,opt,name=alerts,proto3" json:"alerts"`
	Created          float64       `protobuf:"fixed64,100,opt,name=created,proto3" json:"created"`
	Modified         float64       `protobuf:"fixed64,101,opt,name=modified,proto3" json:"modified"`
}
...
// CheckAlerts specifies alerts for a check.
// At most only one check type specific alerts field (besides CommonAlerts) can be set.
type CheckAlerts struct {
	Common *CommonAlerts `protobuf:"bytes,1,opt,name=common,proto3" json:"common,omitempty"`
	Ping   *PingAlerts   `protobuf:"bytes,2,opt,name=ping,proto3" json:"ping,omitempty"`
	Http   *HttpAlerts   `protobuf:"bytes,3,opt,name=http,proto3" json:"http,omitempty"`
}

func (m *CheckAlerts) Reset()         { *m = CheckAlerts{} }
func (m *CheckAlerts) String() string { return proto.CompactTextString(m) }
func (*CheckAlerts) ProtoMessage()    {}
func (*CheckAlerts) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{45}
}
func (m *CheckAlerts) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CheckAlerts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CheckAlerts.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CheckAlerts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CheckAlerts.Merge(m, src)
}
func (m *CheckAlerts) XXX_Size() int {
	return m.Size()
}
func (m *CheckAlerts) XXX_DiscardUnknown() {
	xxx_messageInfo_CheckAlerts.DiscardUnknown(m)
}

var xxx_messageInfo_CheckAlerts proto.InternalMessageInfo

// CommonAlerts specifies alerts supported for every check type.
type CommonAlerts struct {
	ProbeFailedExecutionsTooHigh *Alert `protobuf:"bytes,1,opt,name=probeFailedExecutionsTooHigh,proto3" json:"probeFailedExecutionsTooHigh,omitempty"`
}

func (m *CommonAlerts) Reset()         { *m = CommonAlerts{} }
func (m *CommonAlerts) String() string { return proto.CompactTextString(m) }
func (*CommonAlerts) ProtoMessage()    {}
func (*CommonAlerts) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{46}
}
func (m *CommonAlerts) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CommonAlerts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CommonAlerts.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CommonAlerts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CommonAlerts.Merge(m, src)
}
func (m *CommonAlerts) XXX_Size() int {
	return m.Size()
}
func (m *CommonAlerts) XXX_DiscardUnknown() {
	xxx_messageInfo_CommonAlerts.DiscardUnknown(m)
}

var xxx_messageInfo_CommonAlerts proto.InternalMessageInfo

// PingAlerts specifies alerts supported for the Ping check type.
type PingAlerts struct {
	IcmpDurationTooHighP50 *Alert `protobuf:"bytes,1,opt,name=icmpDurationTooHighP50,proto3" json:"icmpDurationTooHighP50,omitempty"`
	IcmpDurationTooHighP90 *Alert `protobuf:"bytes,2,opt,name=icmpDurationTooHighP90,proto3" json:"icmpDurationTooHighP90,omitempty"`
	IcmpDurationTooHighP95 *Alert `protobuf:"bytes,3,opt,name=icmpDurationTooHighP95,proto3" json:"icmpDurationTooHighP95,omitempty"`
	IcmpDurationTooHighP99 *Alert `protobuf:"bytes,4,opt,name=icmpDurationTooHighP99,proto3" json:"icmpDurationTooHighP99,omitempty"`
}

func (m *PingAlerts) Reset()         { *m = PingAlerts{} }
func (m *PingAlerts) String() string { return proto.CompactTextString(m) }
func (*PingAlerts) ProtoMessage()    {}
func (*PingAlerts) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{47}
}
func (m *PingAlerts) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PingAlerts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PingAlerts.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PingAlerts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PingAlerts.Merge(m, src)
}
func (m *PingAlerts) XXX_Size() int {
	return m.Size()
}
func (m *PingAlerts) XXX_DiscardUnknown() {
	xxx_messageInfo_PingAlerts.DiscardUnknown(m)
}

var xxx_messageInfo_PingAlerts proto.InternalMessageInfo

// HttpAlerts specifies alerts supported for the HTTP check type.
type HttpAlerts struct {
	RequestDurationTooHighP50        *Alert `protobuf:"bytes,1,opt,name=requestDurationTooHighP50,proto3" json:"requestDurationTooHighP50,omitempty"`
	RequestDurationTooHighP90        *Alert `protobuf:"bytes,2,opt,name=requestDurationTooHighP90,proto3" json:"requestDurationTooHighP90,omitempty"`
	RequestDurationTooHighP95        *Alert `protobuf:"bytes,3,opt,name=requestDurationTooHighP95,proto3" json:"requestDurationTooHighP95,omitempty"`
	RequestDurationTooHighP99        *Alert `protobuf:"bytes,4,opt,name=requestDurationTooHighP99,proto3" json:"requestDurationTooHighP99,omitempty"`
	TargetCertificateCloseToExpiring *Alert `protobuf:"bytes,5,opt,name=targetCertificateCloseToExpiring,proto3" json:"targetCertificateCloseToExpiring,omitempty"`
}

func (m *HttpAlerts) Reset()         { *m = HttpAlerts{} }
func (m *HttpAlerts) String() string { return proto.CompactTextString(m) }
func (*HttpAlerts) ProtoMessage()    {}
func (*HttpAlerts) Descriptor() ([]byte, []int) {
	return fileDescriptor_a921b63774164c1f, []int{48}
}
func (m *HttpAlerts) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HttpAlerts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HttpAlerts.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HttpAlerts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HttpAlerts.Merge(m, src)
}
func (m *HttpAlerts) XXX_Size() int {
	return m.Size()
}
func (m *HttpAlerts) XXX_DiscardUnknown() {
	xxx_messageInfo_HttpAlerts.DiscardUnknown(m)
}

var xxx_messageInfo_HttpAlerts proto.InternalMessageInfo

// Alert represents an individual alert for a check.
type Alert struct {
	Id        int64   `protobuf:"varint,1,opt,name=id,proto3" json:"id"`
	Threshold float64 `protobuf:"fixed64,2,opt,name=threshold,proto3" json:"threshold"`
	Created   float64 `protobuf:"fixed64,100,opt,name=created,proto3" json:"created"`
	Modified  float64 `protobuf:"fixed64,101,opt,name=modified,proto3" json:"modified"`
}
...
func init() {
	...
	proto.RegisterType((*CheckAlerts)(nil), "synthetic_monitoring.CheckAlerts")
	proto.RegisterType((*CommonAlerts)(nil), "synthetic_monitoring.CommonAlerts")
	proto.RegisterType((*PingAlerts)(nil), "synthetic_monitoring.PingAlerts")
	proto.RegisterType((*HttpAlerts)(nil), "synthetic_monitoring.HttpAlerts")
	proto.RegisterType((*Alert)(nil), "synthetic_monitoring.Alert")
}
...
var fileDescriptor_a921b63774164c1f = []byte{
	...
	,
}
...
func (m *AdHocCheck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Probes) > 0 {
		dAtA15 := make([]byte, len(m.Probes)*10)
		var j14 int
		for _, num1 := range m.Probes {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintChecks(dAtA, i, uint64(j14))
		i--
		dAtA[i] = 0x2a
	}
	{
...
func (m *CheckAlerts) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CheckAlerts) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CheckAlerts) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CommonAlerts) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CommonAlerts) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CommonAlerts) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.ProbeFailedExecutionsTooHigh != nil {
		{
			size, err := m.ProbeFailedExecutionsTooHigh.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *PingAlerts) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PingAlerts) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PingAlerts) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.IcmpDurationTooHighP99 != nil {
		{
			size, err := m.IcmpDurationTooHighP99.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.IcmpDurationTooHighP95 != nil {
		{
			size, err := m.IcmpDurationTooHighP95.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.IcmpDurationTooHighP90 != nil {
		{
			size, err := m.IcmpDurationTooHighP90.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.IcmpDurationTooHighP50 != nil {
		{
			size, err := m.IcmpDurationTooHighP50.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HttpAlerts) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HttpAlerts) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HttpAlerts) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.TargetCertificateCloseToExpiring != nil {
		{
			size, err := m.TargetCertificateCloseToExpiring.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.RequestDurationTooHighP99 != nil {
		{
			size, err := m.RequestDurationTooHighP99.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.RequestDurationTooHighP95 != nil {
		{
			size, err := m.RequestDurationTooHighP95.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.RequestDurationTooHighP90 != nil {
		{
			size, err := m.RequestDurationTooHighP90.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.RequestDurationTooHighP50 != nil {
		{
			size, err := m.RequestDurationTooHighP50.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CommonAlerts) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ProbeFailedExecutionsTooHigh != nil {
		l = m.ProbeFailedExecutionsTooHigh.Size()
		n += 1 + l + sovChecks(uint64(l))
	}
	return n
}

func (m *PingAlerts) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.IcmpDurationTooHighP50 != nil {
		l = m.IcmpDurationTooHighP50.Size()
		n += 1 + l + sovChecks(uint64(l))
	}
	if m.IcmpDurationTooHighP90 != nil {
		l = m.IcmpDurationTooHighP90.Size()
		n += 1 + l + sovChecks(uint64(l))
	}
	if m.IcmpDurationTooHighP95 != nil {
		l = m.IcmpDurationTooHighP95.Size()
		n += 1 + l + sovChecks(uint64(l))
	}
	if m.IcmpDurationTooHighP99 != nil {
		l = m.IcmpDurationTooHighP99.Size()
		n += 1 + l + sovChecks(uint64(l))
	}
	return n
}

func (m *HttpAlerts) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.RequestDurationTooHighP50 != nil {
		l = m.RequestDurationTooHighP50.Size()
		n += 1 + l + sovChecks(uint64(l))
	}
	if m.RequestDurationTooHighP90 != nil {
		l = m.RequestDurationTooHighP90.Size()
		n += 1 + l + sovChecks(uint64(l))
	}
	if m.RequestDurationTooHighP95 != nil {
		l = m.RequestDurationTooHighP95.Size()
		n += 1 + l + sovChecks(uint64(l))
	}
	if m.RequestDurationTooHighP99 != nil {
		l = m.RequestDurationTooHighP99.Size()
		n += 1 + l + sovChecks(uint64(l))
	}
	if m.TargetCertificateCloseToExpiring != nil {
		l = m.TargetCertificateCloseToExpiring.Size()
		n += 1 + l + sovChecks(uint64(l))
	}
	return n
}
...
func (m *CheckAlerts) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CheckAlerts: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CheckAlerts: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CommonAlerts) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommonAlerts: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommonAlerts: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProbeFailedExecutionsTooHigh", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ProbeFailedExecutionsTooHigh == nil {
				m.ProbeFailedExecutionsTooHigh = &Alert{}
			}
			if err := m.ProbeFailedExecutionsTooHigh.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *PingAlerts) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PingAlerts: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PingAlerts: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IcmpDurationTooHighP50", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.IcmpDurationTooHighP50 == nil {
				m.IcmpDurationTooHighP50 = &Alert{}
			}
			if err := m.IcmpDurationTooHighP50.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IcmpDurationTooHighP90", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.IcmpDurationTooHighP90 == nil {
				m.IcmpDurationTooHighP90 = &Alert{}
			}
			if err := m.IcmpDurationTooHighP90.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IcmpDurationTooHighP95", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.IcmpDurationTooHighP95 == nil {
				m.IcmpDurationTooHighP95 = &Alert{}
			}
			if err := m.IcmpDurationTooHighP95.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IcmpDurationTooHighP99", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.IcmpDurationTooHighP99 == nil {
				m.IcmpDurationTooHighP99 = &Alert{}
			}
			if err := m.IcmpDurationTooHighP99.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *HttpAlerts) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HttpAlerts: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HttpAlerts: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestDurationTooHighP50", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RequestDurationTooHighP50 == nil {
				m.RequestDurationTooHighP50 = &Alert{}
			}
			if err := m.RequestDurationTooHighP50.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestDurationTooHighP90", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RequestDurationTooHighP90 == nil {
				m.RequestDurationTooHighP90 = &Alert{}
			}
			if err := m.RequestDurationTooHighP90.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestDurationTooHighP95", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RequestDurationTooHighP95 == nil {
				m.RequestDurationTooHighP95 = &Alert{}
			}
			if err := m.RequestDurationTooHighP95.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestDurationTooHighP99", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RequestDurationTooHighP99 == nil {
				m.RequestDurationTooHighP99 = &Alert{}
			}
			if err := m.RequestDurationTooHighP99.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetCertificateCloseToExpiring", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TargetCertificateCloseToExpiring == nil {
				m.TargetCertificateCloseToExpiring = &Alert{}
			}
			if err := m.TargetCertificateCloseToExpiring.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
