...
func (sc *SafeConfig) ReloadConfig(confFile string, logger logger.Logger) (err error) {
	var c = &Config{}
	defer func() {
		if err != nil {
	...
	for name, module := range c.Modules {
		if module.HTTP.NoFollowRedirects != nil {
			...
			if logger != nil {
				logger.Log("level", "warn", "msg", "no_follow_redirects is deprecated and will be removed in the next release. It is replaced by follow_redirects.", "module", name)
			}
		}
	}
