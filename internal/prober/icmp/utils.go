...
func chooseProtocol(ctx context.Context, ipProtocol string, fallbackIPProtocol bool, target string, retries int, registry *prometheus.Registry, logger logger.Logger) (ip *net.IPAddr, lookupTime float64, err error) {
