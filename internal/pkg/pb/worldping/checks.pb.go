...
type Check struct {
	...
	OrgId                int64         `protobuf:"varint,2,opt,name=orgId,proto3" json:"org_id"`
...
type HttpCheckValidations struct {
	...
	ResponseTime         *ResponseTimeValidation `protobuf:"bytes,3,opt,name=responseTime,proto3" json:"response_time,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
type PingCheckValidation struct {
	ResponseTime         *ResponseTimeValidation `protobuf:"bytes,1,opt,name=responseTime,proto3" json:"response_time,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
var fileDescriptor_a921b63774164c1f = []byte{
	...
	,
}
