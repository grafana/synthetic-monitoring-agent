...
ARG TARGETARCH
ARG HOST_DIST=$TARGETOS-$TARGETARCH
ARG K6_V1_VERSION=v1.1.7
ARG K6_V2_VERSION=v2.0.2
...
FROM ghcr.io/grafana/chromium-swiftshader-alpine:149.0.7827.53-r0-3.23.4@sha256:d6d6a5dadec5a4a92ea746bcf2357a26edeed313e3d4debb953aa4cf02a9b72f AS with-browser
